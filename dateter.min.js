...
true){settingsHold=a.data("Settings");settingsHold.cellWidth="14.2%";settingsHold.cellHeight="16.6%";settingsHold.width="100%";a.data("Settings",settingsHold);if(a.data("Settings").headerSelectors.title!=-1){a.empty().html(b("<div/>"));a.data("Settings").headerSelectors.next!=-1&&b.fn.dateter.moveMonth(a.data("Settings").headerSelectors.next,a.data("Settings"),a,1);a.data("Settings").headerSelectors.back!=-1&&b.fn.dateter.moveMonth(a.data("Settings").headerSelectors.back,a.data("Settings"),a,-1)}}b.fn.dateter.drawCalendar(a,
...
6-15})};b.fn.dateter.drawCalendar=function(a,d,c){localSettings=b.extend(true,a.data("Settings"),d);a.data("Settings",localSettings);var e="";if(localSettings.displayHeader){a.html(b("<div/>",{css:{"box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",display:"table",height:"20px",width:"100%"}}).addClass(localSettings.shadeClass).html(b("<div/>",{id:localSettings.uniqueName+"calBackMonth",css:{"box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",
display:"table-cell","text-align":"center",width:"20px",cursor:"pointer"},html:b("<font/>",{html:"&laquo;"})})).append(b("<div/>",{id:localSettings.uniqueName+"caltitle",css:{"box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",display:"table-cell",width:"auto","text-align":"center","font-size":"14px"},html:b("<font/>",{html:Date.today().set({month:parseInt(localSettings.month)-1}).toString("MMMM")+" "+localSettings.year}).addClass(localSettings.fontColor)})).append(b("<div/>",
{id:localSettings.uniqueName+"calNextMonth",css:{"box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",display:"table-cell","text-align":"center",width:"20px",cursor:"pointer"},html:b("<font/>",{html:"&raquo;"}).addClass(localSettings.fontColor)})));b.fn.dateter.moveMonth(b("#"+localSettings.uniqueName+"calBackMonth"),localSettings,a,-1,c);b.fn.dateter.moveMonth(b("#"+localSettings.uniqueName+"calNextMonth"),localSettings,a,1,c)}else{a.html($("<div/>",{css:{display:"table",
width:"100%"}}));localSettings.headerSelectors.title!=-1&&localSettings.headerSelectors.title.html(Date.today().set({month:parseInt(localSettings.month)-1}).toString("MMMM")+" "+localSettings.year)}var f=d=0;e=0;if(localSettings.displayHeader){realCellHeight=parseInt(parseInt(localSettings.height)-20)/6;realCellHeight--;e=localSettings.height-20}else{realCellHeight=parseInt(localSettings.height)/6;realCellHeight--;e=localSettings.height}a.append(e=b("<div/>",{id:"calBox"+localSettings.uniqueName,
css:{display:"table",width:localSettings.width,height:e}}).addClass(localSettings.borderClass));e.empty();for(var g=0;g<6;g++){e.append(b("<div/>",{id:localSettings.uniqueName+"w"+g,css:{display:"table-row"}}));for(var i=0;i<7;i++){b("#"+localSettings.uniqueName+"w"+g).append(b("<div/>",{css:{"box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",display:"table-cell",fontSize:"11px",textAlign:"center",width:localSettings.cellWidth,height:localSettings.cellHeight},
...
true)curDay.html(b("<div/>",{id:"dayBox"+f,css:{display:"table","box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",overflow:"hidden",height:"100%",width:"100%"},html:clickArea=b("<div/>",{css:{display:"table-row","box-sizing":"border-box","-moz-box-sizing":"border-box","-webkit-box-sizing":"border-box",borderTop:0,borderLeft:0,borderRight:0,width:"100%",cursor:"pointer",height:"15px"},"class":localSettings.borderClass+" "+localSettings.shadeClass+" "+localSettings.fontColor,
html:f})}).append(clickArea2=b("<div/>",{id:"eventBox"+f,css:{display:"table-row",borderTop:0,borderLeft:0,borderRight:0,overFlow:"hidden",cursor:"pointer",width:"100%",height:"auto"},"class":"clickarea2"})));else clickArea=curDay.css({height:realCellHeight,cursor:"pointer"}).addClass(localSettings.fontColor).html(f);if(localSettings.pastDayShades)curDay.addClass(h[1]||h[2]||h[3]?localSettings.pastDayShadeClass:localSettings.calendarCell).css({cursor:"pointer"});localSettings.highLightToday&&Date.today().toString("d")==
f&&Date.today().toString("M")==localsettings.month&&Date.today().toString("yyyy")==localsettings.year&&curDay.addClass(localSettings.highLightTodayClass).removeClass(localSettings.pastDayShadeClass).css({cursor:"pointer"});!localSettings.pastDayShades&&!(Date.today().toString("d")==f&&Date.today().toString("M")==localsettings.month&&Date.today().toString("yyyy")==localsettings.year)&&curDay.addClass(localSettings.calendarCell);clickArea.click(function(){if(a.data("Settings").callbackFn){b("#Shadow").remove();
a.data("Settings").callbackFn(localSettings.month,b(this).text(),localSettings.year);if(a.data("Settings").noClick===false){c.show();a.parent().fadeOut(300)}}})}else{curDay=b("#"+localSettings.uniqueName+"d"+d);localSettings.largeDisplay===true?curDay.html(b("<div/>",{id:"dayBox"+f,css:{overflow:"hidden",height:"100%",width:"100%"}}).html(clickArea=b("<div/>",{html:b("<font/>",{"class":localSettings.fontColor,html:"&nbsp;"}),css:{borderTop:0,borderLeft:0,borderRight:0,width:"100%",height:"16px"}})).append(clickArea2=
b("<div/>",{id:"eventBox"+f,css:{borderTop:0,borderLeft:0,borderRight:0,overFlow:"hidden",width:"100%",height:parseInt(realCellHeight-15)},"class":"clickarea2"}))):curDay.html(b("<div/>",{css:{height:realCellHeight},html:"&nbsp;"}))}d++}}b.fn.dateter.drawHighlight(localSettings);if(a.data("Settings").monthSwitchFn)if(a.data("Settings").initialFetchMonths==0)a.data("Settings").monthSwitchFn(localSettings.month,-1,localSettings.year);else for(v=1;v<parseInt(a.data("Settings").initialFetchMonths);v++){d=
Date.today().add(a.data("Settings").monthsMoved-v).months().toString("yyyy");f=Date.today().add(a.data("Settings").monthsMoved-v).months().toString("M");e=Date.today().add(a.data("Settings").monthsMoved+v).months().toString("yyyy");g=Date.today().add(a.data("Settings").monthsMoved+v).months().toString("M");a.data("Settings").monthSwitchFn(g,-1,e);a.data("Settings").monthSwitchFn(f,-1,d)}}})(jQuery);
